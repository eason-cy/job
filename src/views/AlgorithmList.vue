  ...
  <div class="algorithm-list">
    ...
    <div class="panel">
      ...
      <div class="quick-filters">
        <el-button size="small" @click="applyDifficultyPreset('')">All</el-button>
        <el-button size="small" @click="applyDifficultyPreset('Easy')">Easy</el-button>
        <el-button size="small" @click="applyDifficultyPreset('Medium')">Medium</el-button>
